...
void main() {
  test(
    'like-back passes fromCard and unlocks chat when inbound exists',
    () async {
      ...
      expect(
        repo.lastFromCard?.imageUrls.single,
  ...
  test(
    'applyInboundPush chatReady activates icons for existing outbound',
    () async {
      final repo = _CaptureLikesRepository();
      final likes = LikesStore(repository: repo);
      await likes.like(
